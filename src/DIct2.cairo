...
// Your task is to create a function that multiplies the elements stored at the indexes 0 to n of 
// a dictionary by 10 Make me compile and pass the test!.
...
fn multiply_element_by_10(ref dict: Felt252Dict<u32>, n: usize) {
    ...
    let mut i = 0;
    while i < n {
        let val = dict.get(i.into());
        dict.insert(i.into(), val * 10);
        i += 1;
    }
}
