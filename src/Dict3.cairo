// Custom data structure using dicts Using Felt252Dict in structs allow us to simulate 
// mutable data structures In this exercise we have a struct Team where a Felt252Dict 
// maps the name of a player to its level and keeps track of the number of player.

// Using the methods set and get from the Felt252DictTrait, implement the required 
// functions to interact with the team Make me compile and pass the test!.
...
impl TeamImpl of TeamTrait {
    ...
    fn level_up(ref self: Team, name: felt252) {
        //TODO
        let new_level = self.level.get(name) + 1;
