// Fill in the rest of the line that has code missing! No hints, there's no tricks, just get used to typing these :).
...
fn main() {
    ...
    let  mut your_character= 'G'// Finish this line like the example! What's your favorite short string?
