...
// Now they decided to write a contract to track the number of exercises they complete successfully. 
// Jill says they can use the owner code and allow only the owner to update the contract, they agree.
...
mod ProgressTracker {
    ...
    impl ProgressTrackerImpl of super::IProgressTracker<ContractState> {
        ...
        // TODO: set new_progress for user,
            ...
            assert(caller == self.contract_owner.read(), 'Only owner can update');
